...
<table border="1">
    ...
    <?php foreach ($rs as $fila) { ?>
        <tr>
            <td><a href='6-personaFicha.php?id=<?=$fila["id"]?>'><?=$fila["nombre"]?></a> </td>
            <td><a href='6-personaFicha.php?id=<?=$fila["id"]?>'><?=$fila["telefono"]?></a> </td>
            <td><a href='6-personaFicha.php?id=<?=$fila["id"]?>'><?=$fila["categoriaId"]?></a> </td>
